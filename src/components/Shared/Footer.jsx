                ...
                <div className='max-w-screen-xl mx-auto md:flex justify-around gap-16 items-center px-5 md:px-3'>
                    ...
                    <div className='w-full'>
                        <form className='w-full'>
                            ...
                            <input className='w-4/5 rounded px-4 my-2 py-2' type="text" placeholder='Name' /> <br />
                            <input className='w-4/5 rounded px-4 my-2 py-2' type="text" placeholder='Email' /><br />
                            <input className='w-4/5 rounded px-4 mt-2 mb-6 py-2' type="text" placeholder='Message' /><br />
                            <span className='border-2 text-xl border-[#331A15] py-2 px-5 font-rancho font-semibold cursor-pointer rounded-full'>Send Message</span>
                        </form>
                    </div>
                </div>
            </div>
